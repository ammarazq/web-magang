...
<head>
    ...
    <title>Upload Dokumen D3 - {{ $mahasiswa->nama_lengkap }}</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="fas fa-graduation-cap"></i> Upload Dokumen Diploma III (D3)
            </a>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-1"><small><strong>Program:</strong></small><br>Diploma III (D3)</p>
            ...
            <div class="col-md-9">
                <form action="{{ route('sarjana.upload.submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="upload-section">
                        <h5 class="mb-3">
                            <i class="fas fa-folder"></i> Dokumen Persyaratan D3
                        </h5>
                        <p class="text-muted mb-3">
                            <i class="fas fa-info-circle"></i> Upload dokumen persyaratan untuk program Diploma III (D3). 
