...
<head>
    ...
    <title>Upload Dokumen D4 - {{ $mahasiswa->nama_lengkap }}</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="#">
                <i class="fas fa-graduation-cap"></i> Upload Dokumen Diploma IV (D4)
            </a>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-1"><small><strong>Program:</strong></small><br>Diploma IV (D4)</p>
            ...
            <div class="col-md-9">
                <form action="{{ route('sarjana.upload.submit') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="upload-section">
                        <h5 class="mb-3">
                            <i class="fas fa-folder"></i> Dokumen Persyaratan D4
                        </h5>
                        <p class="text-muted mb-3">
                            <i class="fas fa-info-circle"></i> Upload dokumen persyaratan untuk program Diploma IV (D4). 
                    ...
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0 mt-2">
                            ...
                            <li>Program D4 setara dengan Sarjana Terapan</li>
                        </ul>
                    </div>
    ...
    <script>
            ...
            fileInputs.forEach(input => {
                input.addEventListener('change', function(e) {
                    ...
                    if (inputName === 'foto_formal' || inputName === 'ktp') {
                        ...
                        showError('Format file tidak didukung!\nHanya file JPG/JPEG/PDF yang diperbolehkan.');
                        e.target.value = '';
                        return;
                    }
                    ...
                    if (isDuplicate) {
                        ...
                        showError(
                            ...
                            `File "${fileName}" sudah dipilih untuk:\n` +
        ...
        function showSuccess(message) {
            ...
            if (firstAlert) {
                container.insertBefore(alertDiv, firstAlert);
            } else {
                container.insertBefore(alertDiv, container.firstChild);
            }
