...
@section('title', 'Layanan TAPS - SALUT Insan Cendekia')
    ...
    <div class="container">
        <div class="row d-flex align-items-center justify-content-center">
            <div class="about-content col-lg-12">
                ...
                <p class="text-white link-nav"><a href="{{ url('/') }}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="{{ route('layanan_taps') }}"> Layanan TAPS</a></p>
            </div>
        </div>
    </div>
</section>
...
<section class="course-details-area pt-120 pb-120" style="background-color: #fafbfc;">
    <div class="container">
        <div class="row mb-5">
            <div class="col-lg-12">
                <h2 style="font-weight: 700; color: #222; margin-bottom: 20px;">Layanan TAPS</h2>
                <p style="color: #777; font-size: 16px; line-height: 1.8;">
                    Layanan Perkuliahan Mahasiswa Universitas Terbuka di SALUT Insan Cendekia terkait Tugas Akhir Program Sarjana (TAPS) dan kegiatan praktik.
                </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="registration-table-wrap" style="background: white; border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); padding: 40px;">
                    <h3 class="mb-4" style="font-weight: 700; color: #222; font-size: 28px;">Jenis Layanan TAPS</h3>
                        ...
                        <table class="table" style="border-collapse: separate; border-spacing: 0; min-width: 800px; margin-bottom: 0;">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="border-bottom: 1px solid #f4f6f8; border-top: none; color: #777; padding: 25px 20px; vertical-align: middle; font-size: 16px;">Konsultasi TAPS</td>
                                ...
                                <tr>
                                    ...
                                    <td style="border-bottom: 1px solid #f4f6f8; border-top: none; color: #777; padding: 25px 20px; vertical-align: middle; font-size: 16px;">Pendaftaran Bimbingan Penulisan Artikel Ilmiah</td>
                                    <td style="border-bottom: 1px solid #f4f6f8; border-top: none; padding: 25px 20px; vertical-align: middle;">
                                ...
                                <tr>
                                    ...
                                    <td style="border-bottom: 1px solid #f4f6f8; border-top: none; color: #777; padding: 25px 20px; vertical-align: middle; font-size: 16px;">Permohonan Surat Pengantar Proyek</td>
                                    <td style="border-bottom: 1px solid #f4f6f8; border-top: none; padding: 25px 20px; vertical-align: middle;">
                                        <a href="#" class="btn" style="background-color: #409df5; color: white; padding: 10px 30px; border-radius: 4px; font-weight: 500; font-size: 14px; border: none; box-shadow: none;">Unduh</a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="border-bottom: none; border-top: none; color: #777; padding: 25px 20px; vertical-align: middle; font-size: 16px;">Permohonan Surat Pengantar Praktik Mengajar</td>
